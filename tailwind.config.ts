    ...
    extend: {
      colors: {
        ...
        node: {
          ...
          comment: "hsl(var(--node-comment))",
          pin: "hsl(var(--node-pin))",
          "pin-exec": "hsl(var(--node-pin-exec))",
          "pin-data": "hsl(var(--node-pin-data))",
          "pin-boolean": "hsl(var(--node-pin-boolean))",
